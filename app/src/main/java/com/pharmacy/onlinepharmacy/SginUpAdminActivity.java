...
public class SginUpAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sgin_up_admin);
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkEmail(Email) && checkPassword()){
                    ...
                    FA.createUserWithEmailAndPassword(Email, Password).addOnCompleteListener(SginUpAdminActivity.this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                CollectionReference userData = Ff.collection("Admins");
